    ...
    return (
      <Layout>
        ...
        <div className="py-20 text-center">
          ...
          <p className="mt-3 font-semibold text-text-primary">Admin access required</p>
          <button
            onClick={login}
  ...
  if (!isAdmin) {
    return (
      <Layout>
        ...
        <div className="py-20 text-center">
          <p className="text-4xl">🚫</p>
          <p className="mt-3 font-semibold text-text-primary">Not authorized</p>
  ...
  return (
    <div className="rounded-xl border border-accent/30 bg-bg-card p-5">
      <div className="mb-4 flex items-center gap-2">
        ...
        <h2 className="text-lg font-semibold text-text-primary">Generate with AI</h2>
          ...
          {suggestions.map((s, i) => (
            ...
            >
              <div className="mb-1 flex items-start justify-between gap-2">
                <p className="text-sm font-medium text-text-primary">{s.question}</p>
                <button
...
function CreateMarketForm({ prefill }: { prefill?: Partial<CreateForm> | null }) {
  ...
  return (
    <div id="create-market-section" className="rounded-xl border border-bg-border bg-bg-card p-5">
      <h2 className="mb-4 text-lg font-semibold text-text-primary">Create Market</h2>
    ...
    <div className="rounded-xl border border-bg-border bg-bg-card p-4">
      <div className="mb-2 flex items-start justify-between gap-2">
        <div>
          <Link
            ...
            className="text-sm font-medium text-text-primary hover:text-text-primary"
          >
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="ml-auto rounded-lg border border-bg-border px-3 py-1.5 text-xs text-text-secondary hover:border-text-muted hover:text-text-primary disabled:opacity-50"
        >
...
const inputClass =
  'w-full rounded-lg border border-bg-border bg-bg-primary px-3 py-2 text-sm text-text-primary placeholder-text-muted outline-none transition-colors focus:border-accent';
